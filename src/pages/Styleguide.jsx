...
function Styleguide() {
    ...
    const contact = {
        ...
        title: "get in touch",
        contactList: [
            { type: "Email", icon: "fa-regular fa-paper-plane", url: "#", value:"info.contact@gmail.com" },
            { type: "Phone", icon: "fa-brands fa-github", url: "#", value: "(00) 123 456 789" },
            { type: "Address", icon: "fa-brands fa-codepen", url: "#", value: "40 Bacia Street 133/2 NewYork City, US" },
        ]
    }
    const subject = {
        intro: "heLLo woRld!",
